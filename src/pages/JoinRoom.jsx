      ...
      <div className="bg-[#111111] border border-gray-800 w-full max-w-md rounded-2xl p-8 md:p-10 shadow-2xl">
        ...
        <form className="mt-10 space-y-5" >
          ...
          <div className="pt-4 space-y-3">
            <button className="w-full bg-blue-600 hover:bg-blue-500 text-white py-3.5 rounded-xl font-bold text-lg transition-all transform active:scale-[0.98] shadow-lg shadow-blue-500/10">
              Enter Room
            </button>
            <button 
