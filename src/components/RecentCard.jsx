            ...
            <div className='flex flex-col md:flex-row md:items-center justify-between gap-2'>
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-bold text-gray-100">You</span>
                    <span className="text-gray-500 text-xs tracking-wide uppercase font-bold">Created</span>
                    <span className="text-blue-400 font-mono text-sm hover:underline cursor-pointer">#WheelSync-Backend</span>
                  </div>
                ...
                <div className='flex items-center gap-4 text-right'>
                    <div className='flex flex-col items-end'>
                        <div className='flex items-center gap-1.5 text-gray-600'>
                            <Clock size={12} />
                            <p className="text-[10px] font-bold uppercase tracking-widest">2m ago</p>
                        </div>
                    </div>
